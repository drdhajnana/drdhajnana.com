...
mixin DrawCheck {
  ...
  bool drawCheck(int count, LaunchPadModel launchPadModel) {
    ...
    int dia2 = launchPadModel.placeValue[2] +
        launchPadModel.placeValue[4] +
        launchPadModel.placeValue[6];
    if (row1 == 11 || row1 == 7 || row1 == 6 || (row1 == 2 && count == 8)) {
      drawCount++;
    }
    if (row2 == 11 || row2 == 7 || row2 == 6 || (row2 == 2 && count == 8)) {
      drawCount++;
    }
    if (row3 == 11 || row3 == 7 || row3 == 6 || (row3 == 2 && count == 8)) {
      drawCount++;
    }
    if (col1 == 11 || col1 == 7 || col1 == 6 || (col1 == 2 && count == 8)) {
      drawCount++;
    }
    if (col2 == 11 || col2 == 7 || col2 == 6 || (col2 == 2 && count == 8)) {
      drawCount++;
    }
    if (col3 == 11 || col3 == 7 || col3 == 6 || (col3 == 2 && count == 8)) {
      drawCount++;
    }
    if (dia1 == 11 || dia1 == 7 || dia1 == 6 || (dia1 == 2 && count == 8)) {
      drawCount++;
    }
    if (dia2 == 11 || dia2 == 7 || dia2 == 6 || (dia2 == 2 && count == 8)) {
      drawCount++;
    }
    if (drawCount == 8) {
      draw = true;
